    ...
    <div class="card-body">
      <div class="col-md-12">
        ...
        @if ($errors->any())
         ...
         @endif
        <form action="{{route("kepala.kategori.add_action")}}" method="post">
          @csrf
      ...
      <table class="table dt">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{$value->ket}}</td>
            <td>
              <a href="{{route("kepala.kategori.update",$value->id_kategori)}}" class="btn btn-warning">
                <i class="fa fa-edit"></i>
              </a>
              <a href="{{route("kepala.kategori.delete",$value->id_kategori)}}" class="btn btn-danger">
